...
The unusual aspect of this code is that the class is annotated @Async, but within the methods `callback.call` is called.
Notmally the Callable is just submitted to Executor.
